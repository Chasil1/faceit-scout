# Faceit Scout — Інструмент для піку гравців у Dota 2

Легкий десктопний застосунок і веб-інтерфейс, який допомагає капітанам обирати гравців у команду під час лобі на Faceit.  
...
3. Коли матч перейде у стадію піків, інтерфейс автоматично переключиться на триколонковий вигляд — капітани ліворуч і праворуч, спільний пул гравців у центрі:

![Стадія піків](screenshots/draft.jpg)

4. Після завершення піків відобразяться сформовані команди:

![Сформовані команди](screenshots/teams.jpg)
